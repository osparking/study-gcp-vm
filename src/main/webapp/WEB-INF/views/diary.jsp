		...
		<table>
			<tr>
				<td style="text-align: right" colspan="2">
					<a href="/study">홈으로</a></td>
			</tr>		
			<tr>
				<td><label for="studyDate">학습일</label></td>
				<td><input type="date" id="studyDate" name="studyDate"
					<c:if test="${diary != null}">
					readonly value="${diary.studyDate}"</c:if> 
					></td>
			</tr>
			<tr>
				<td><label for="title">제목</label></td>
				<td><input type="text" id="title" name="title"
					placeholder="(학습 주제 - 최대 50자)" maxlength="50" 
					<c:if test="${diary != null}">
					readonly value="${diary.title}"</c:if>
					></td>
			</tr>
			<tr>
				<td><label for="content">내용</label></td>
				<td><textarea id="content" name="content" rows="5" cols="50"
						placeholder="(세부 내용 - 최대 2,000자)" maxlength="2000" 
					<c:if test="${diary != null}">readonly</c:if>
					>${diary.content}</textarea></td>
			</tr>
			<tr>
				<td></td>
				<td class="submit">
